...
import 'package:cinemix/host/p2p_utils.dart';
            ...
            children: [
              ...
              Column(
                children: [
                  ToggleButtons(
                    ...
                    fillColor: Color.fromARGB(255, 16, 0, 48),
              ...
              Column(
                children: [
                  ...
                  SizedBox(height: 24),
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(backgroundColor: Color.fromARGB(255, 16, 0, 48), shape: BeveledRectangleBorder()),
                    onPressed: () async {
                      FilePickerResult? result = await FilePicker.platform.pickFiles();
                      if (result != null) {
                        PlatformFile file = result.files.first;
